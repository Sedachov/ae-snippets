...
var appid = "13675c9354b63ba44239e2c96a1dec77";
var city = "Saint-Petersburg";
var url = "http://api.openweathermap.org";
var query = "/data/2.5/weather?q=" + city + "&appid=" + appid;

var ans = GetURL(url+query, false);
var kelvin = 273;
var weather = JSON.parse(ans.body);
alert("In " + city + ": " + Math.round(weather.main.temp - kelvin));
